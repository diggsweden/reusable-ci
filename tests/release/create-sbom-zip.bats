...
@test "create-sbom-zip skips when no SBOMs found" {
...
@test "create-sbom-zip does not create zip when no SBOMs" {
  run_create_sbom_zip "myapp" "1.0.0"
...
@test "create-sbom-zip creates zip with pom SBOM" {
...
@test "create-sbom-zip creates zip with package SBOM" {
...
@test "create-sbom-zip creates zip with jar SBOM" {
...
@test "create-sbom-zip creates zip with gradle SBOM" {
...
@test "create-sbom-zip includes container SBOMs" {
...
@test "create-sbom-zip includes all three layers" {
  create_pom_sbom "myapp"
  create_jar_sbom "myapp"
  create_container_sbom "myapp"
...
@test "create-sbom-zip strips v prefix from version" {
  create_pom_sbom "myapp"
...
@test "create-sbom-zip handles version without v prefix" {
  create_pom_sbom "myapp"
...
@test "create-sbom-zip handles prerelease versions" {
  create_pom_sbom "myapp"
...
@test "create-sbom-zip uses provided project name" {
...
@test "create-sbom-zip handles project name with hyphens" {
...
@test "create-sbom-zip shows zip contents" {
  create_pom_sbom "myapp"
...
@test "create-sbom-zip shows completion message" {
  create_pom_sbom "myapp"
...
@test "create-sbom-zip includes SPDX format SBOMs" {
...
@test "create-sbom-zip includes CycloneDX format SBOMs" {
...
@test "create-sbom-zip handles empty sbom-artifacts directory" {
  mkdir -p sbom-artifacts
  create_pom_sbom "myapp"
...
@test "create-sbom-zip counts SBOMs correctly" {
  create_pom_sbom "myapp"
  create_jar_sbom "myapp"
  create_container_sbom "myapp"
