...
@test "validate-authorizationrequires tag-name argument" {
  run_validate_authorization
...
@test "validate-authorizationrequires actor argument" {
...
@test "validate-authorizationallows any user for SNAPSHOT releases" {
...
@test "validate-authorizationallows SNAPSHOT with uppercase suffix" {
...
@test "validate-authorizationallows SNAPSHOT even with no authorized devs" {
...
@test "validate-authorizationallows all users when no authorized devs configured" {
...
@test "validate-authorizationwarns about open access when no restrictions" {
...
@test "validate-authorizationallows authorized user" {
...
@test "validate-authorizationallows user from middle of list" {
...
@test "validate-authorizationallows user at end of list" {
...
@test "validate-authorizationallows single authorized user" {
...
@test "validate-authorizationrejects unauthorized user" {
...
@test "validate-authorizationshows error annotation for unauthorized user" {
...
@test "validate-authorizationlists authorized users on rejection" {
...
@test "validate-authorizationsuggests SNAPSHOT alternative on rejection" {
  run_validate_authorization "v1.0.0" "random-user" "admin"
...
@test "validate-authorizationsuggests contacting authorized devs" {
  run_validate_authorization "v1.0.0" "random-user" "admin"
...
@test "validate-authorizationhandles username with hyphen" {
...
@test "validate-authorizationhandles username with underscore" {
  run_validate_authorization "v1.0.0" "user_name" "user_name"

  assert_success
}

@test "validate-authorizationdoes not partial match usernames" {
...
@test "validate-authorizationhandles numeric username" {
...
@test "validate-authorizationrejects user when list has spaces around commas" {
...
@test "validate-authorizationhandles trailing comma in list" {
  run_validate_authorization "v1.0.0" "admin" "admin,developer,"
...
@test "validate-authorizationenforces auth for production release" {
...
@test "validate-authorizationenforces auth for pre-release (non-SNAPSHOT)" {
...
@test "validate-authorizationenforces auth for beta release" {
