...
run_validate_tag_format() {
  run_script "validate/tag-format.sh" "$@"
}
...
@test "validate-tag-formatrejects empty input" {
  run_validate_tag_format ""
...
@test "validate-tag-formatrejects no arguments" {
  run_validate_tag_format
...
@test "validate-tag-formataccepts v1.0.0" {
...
@test "validate-tag-formataccepts v0.0.1" {
...
@test "validate-tag-formataccepts v10.20.30" {
...
@test "validate-tag-formataccepts v0.1.0" {
...
@test "validate-tag-formataccepts v100.200.300" {
...
@test "validate-tag-formataccepts v2.3.4-beta.1" {
...
@test "validate-tag-formataccepts v1.0.0-alpha" {
...
@test "validate-tag-formataccepts v1.0.0-rc.2" {
...
@test "validate-tag-formataccepts v1.0.0-SNAPSHOT" {
...
@test "validate-tag-formataccepts v1.0.0-dev" {
...
@test "validate-tag-formataccepts v1.0.0-alpha.1" {
...
@test "validate-tag-formataccepts v1.0.0-beta" {
...
@test "validate-tag-formataccepts v1.0.0-rc.10" {
...
@test "validate-tag-formatwarns on non-standard prerelease" {
...
@test "validate-tag-formatwarns on unknown prerelease prefix" {
...
@test "validate-tag-formatrejects missing v prefix" {
...
@test "validate-tag-formatrejects uppercase V prefix" {
  run_validate_tag_format "V1.0.0"
...
@test "validate-tag-formatrejects incomplete version" {
...
@test "validate-tag-formatrejects single digit version" {
...
@test "validate-tag-formatrejects version with four parts" {
...
@test "validate-tag-formatrejects non-numeric version" {
...
@test "validate-tag-formatrejects mixed alphanumeric major" {
...
@test "validate-tag-formatrejects release prefix" {
...
@test "validate-tag-formatrejects version prefix" {
...
@test "validate-tag-formatrejects random string" {
...
@test "validate-tag-formatrejects commit-like string" {
...
@test "validate-tag-formataccepts leading zeros in major" {
...
@test "validate-tag-formataccepts leading zeros in minor" {
  # Note: Strict semver rejects leading zeros, but this script accepts them
...
@test "validate-tag-formataccepts leading zeros in patch" {
  # Note: Strict semver rejects leading zeros, but this script accepts them
...
@test "validate-tag-formatshows semver help on failure" {
...
@test "validate-tag-formatshows valid examples on failure" {
...
@test "validate-tag-formatdisplays version components" {
...
@test "validate-tag-formatidentifies stable release" {
  run_validate_tag_format "v1.0.0"
...
@test "validate-tag-formatidentifies pre-release" {
  run_validate_tag_format "v1.0.0-alpha"
