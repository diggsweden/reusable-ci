...
@test "get-file-pattern requires project-type argument" {
  run_get_file_pattern
...
@test "get-file-pattern fails on empty project-type" {
  run_get_file_pattern ""
...
@test "get-file-pattern returns maven pattern" {
...
@test "get-file-pattern includes glob pattern for maven" {
  run_get_file_pattern "maven"
...
@test "get-file-pattern returns npm pattern" {
...
@test "get-file-pattern npm pattern includes lock file" {
  run_get_file_pattern "npm"
...
@test "get-file-pattern returns gradle pattern" {
...
@test "get-file-pattern gradle includes kotlin build files" {
  run_get_file_pattern "gradle"
...
@test "get-file-pattern gradle includes groovy build files" {
  run_get_file_pattern "gradle"
...
@test "get-file-pattern returns gradle-android pattern" {
...
@test "get-file-pattern gradle-android same as gradle" {
...
@test "get-file-pattern returns xcode-ios pattern" {
...
@test "get-file-pattern xcode-ios includes xcconfig glob" {
  run_get_file_pattern "xcode-ios"
...
@test "get-file-pattern returns python pattern" {
...
@test "get-file-pattern returns go pattern" {
...
@test "get-file-pattern returns CHANGELOG.md for unknown type" {
...
@test "get-file-pattern returns CHANGELOG.md for meta type" {
...
@test "get-file-pattern uses custom pattern when provided" {
...
@test "get-file-pattern custom pattern overrides default" {
...
@test "get-file-pattern custom pattern with glob" {
...
@test "get-file-pattern empty custom pattern uses default" {
  run_get_file_pattern "maven" ""
...
@test "get-file-pattern outputs single line" {
  run_get_file_pattern "maven"
