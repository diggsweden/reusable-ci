...
@test "get-version-info outputs warning when gradle.properties not found" {
  run_get_version_info
...
@test "get-version-info outputs version info to stderr" {
...
@test "get-version-info handles version with suffix" {
