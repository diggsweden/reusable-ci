...
@test "decode-keystore fails when ANDROID_KEYSTORE_BASE64 is not set" {
...
@test "decode-keystore fails when ANDROID_KEYSTORE_BASE64 is empty" {
...
@test "decode-keystore decodes keystore successfully" {
...
@test "decode-keystore outputs ANDROID_KEYSTORE_PATH" {
  export ANDROID_KEYSTORE_BASE64="$(create_test_keystore)"
...
@test "decode-keystore outputs success message to stderr" {
  export ANDROID_KEYSTORE_BASE64="$(create_test_keystore)"
...
@test "decode-keystore outputs absolute path" {
  export ANDROID_KEYSTORE_BASE64="$(create_test_keystore)"
