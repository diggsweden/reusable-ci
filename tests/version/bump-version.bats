...
@test "bump-version fails on unknown project type" {
...
@test "bump-version fails on missing arguments" {
  run_bump_version
...
@test "bump-version fails with only project type" {
...
@test "bump-version calls mvn for maven projects" {
...
@test "bump-version fails when mvn fails" {
...
@test "bump-version calls npm version for npm projects" {
...
@test "bump-version fails when npm fails" {
...
@test "bump-version creates xcconfig file if missing for xcode-ios" {
...
@test "bump-version updates existing xcconfig for xcode-ios" {
...
@test "bump-version creates default xcconfig for xcode-ios ignoring custom name" {
...
@test "bump-version handles meta project type" {
...
@test "bump-version meta type does not create files" {
  run_bump_version "meta" "1.0.0" "$TEST_DIR"
