...
#   anything else (SHAs, # branches)         → go install github.com/diggsweden/reusable-ci/cmd/reusable-ci@<ref>
#
...
: "${REUSABLE_CI_MODULE_PATH:=github.com/diggsweden/reusable-ci/cmd/reusable-ci}"
