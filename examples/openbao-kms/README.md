...
```bash
export BAO_ADDR=https://bao.diggsweden.internal
bao login
...
bao write auth/jwt/role/release-signing - <<EOF
{
  "role_type": "jwt",
  "user_claim": "sub",
  "bound_audiences": ["https://bao.diggsweden.internal"],
  "bound_claims": {
    "repository": "diggsweden/myorg",
    "ref_type": "tag"
  },
...
reusable-ci validate container-signature \
    ghcr.io/diggsweden/myorg/my-lib@sha256:abc123... \
    --method kms \
    --key .reusable-ci/release-pubkey.pem
```
