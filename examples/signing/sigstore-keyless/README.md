...
reusable-ci validate artifact-signature \
    ...
    --cert-identity-regexp '^https://github.com/examplescope/myorg/\.github/workflows/release-workflow\.yml@refs/tags/v.+$' \
...
release-workflow.yml in examplescope/myorg on a release tag". The
