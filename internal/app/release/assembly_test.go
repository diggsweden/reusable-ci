...
func TestAssemblyConsumersUseManifestFiles(t *testing.T) {
	...
	writeReleaseAssembly(t, domainrelease.DefaultAssemblyFile, domainrelease.ReleaseAssembly{
...
func writeReleaseAssembly(t *testing.T, path string, asm domainrelease.ReleaseAssembly) {
	t.Helper()
	...
	if err := os.WriteFile(path, []byte(mustReleaseJSON(t, asm)), 0o644); err != nil {
